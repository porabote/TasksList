<form  style="padding: 30px;" method="POST">
    ...
    <div class="form-group">
        ...
        <input disabled="disabled" name="user_email" value="<?=$this->data['record']['user_email']?>" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
        <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
    </div>

    <div class="form-group">
        <label for="exampleInputName1">Name</label>
        <input name="user_name" disabled="disabled" value="<?=$this->data['record']['user_name']?>"  type="text" class="form-control" id="exampleInputName1" required
